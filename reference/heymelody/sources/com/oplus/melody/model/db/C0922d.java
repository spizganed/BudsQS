...
/* JADX INFO: renamed from: com.oplus.melody.model.db.d, reason: case insensitive filesystem */
/* JADX INFO: compiled from: CarouselDressDao_Impl.java */
/* JADX INFO: loaded from: classes3.dex */
public final class C0922d extends G0.c {

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public final /* synthetic */ int f19763j;

    public /* synthetic */ C0922d(int i10) {
        this.f19763j = i10;
    }
    ...
    public final String c() {
        switch (this.f19763j) {
            case 0:
                return "INSERT OR IGNORE INTO `carousel_dress` (`carouselId`,`productId`,`colorId`,`name`,`carouselType`,`themeIdList`) VALUES (nullif(?, 0),?,?,?,?,?)";
            case 1:
