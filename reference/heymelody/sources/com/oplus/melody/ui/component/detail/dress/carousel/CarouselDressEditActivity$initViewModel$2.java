...
final /* synthetic */ class CarouselDressEditActivity$initViewModel$2 extends FunctionReferenceImpl implements l<Integer, Jb.l> {
    @Override // Wb.l
    public final Jb.l d(Integer num) {
        ...
        if (iIntValue == 3) {
            carouselDressEditActivity.finish();
        } else {
