...
public final class AITranslationItem extends MelodyUiCOUIJumpPreference {
    ...
    public static final class b implements v, f {
        ...
        public final /* synthetic */ j f20637a;
    ...
    public AITranslationItem(Context context, DetailMainViewModel viewModel, InterfaceC0601m lifecycleOwner) {
        super(context);
        h.e(context, "context");
        h.e(viewModel, "viewModel");
        h.e(lifecycleOwner, "lifecycleOwner");
        setTitle(R.string.melody_ui_ai_translation_title);
        setOnPreferenceClickListener(new Q8.a(viewModel, context, 0));
        viewModel.d(viewModel.f20397b).e(lifecycleOwner, new b(new j(this, 11)));
    }
    ...
    public static final boolean _init_$lambda$0(DetailMainViewModel detailMainViewModel, Context context, Preference it) {
        ...
        i iVarA = i.a.a("/ui/ai_translation");
        ...
        C1264t.t(AppConstant$FunctionType.AI_TRANSLATION.getFunType(), str, str2, N.t(detailMainViewModel.i(str2)), "");
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Jb.l _init_$lambda$1(AITranslationItem aITranslationItem, int i10) {
        aITranslationItem.setEnabled(i10 == 2);
        return Jb.l.f2618a;
    }
}
